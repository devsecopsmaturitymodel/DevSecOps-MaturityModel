...
import { ActivityAttributeVisibility } from '../../model/report-config';
...
export class ReportActivityComponent implements OnInit, OnChanges {
  @Input() activity: Activity | null = null;
  @Input() iconName: string = '';
  @Input() config!: ActivityAttributeVisibility;
