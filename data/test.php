...
$dimensions [gettext ( "Test and Verification" )] = array (
		gettext ( "Dynamic depth" ) => array (
				...
				gettext ( "Coverage of all input vectors" ) => array (
		...
		gettext ( "Applicationt tests" ) => array (
				gettext ( "Security related module tests" ) => array (
				...
				gettext ( "Security related acceptence tests" ) => array (
						"risk" => "In der Anwendung sind grundlegende Fehler bei der Benutzung eines Frameworks möglich, ohne das diese erkannt werden.",
				...
				gettext ( "High coverage of security related module, integration and acceptence tests" ) => array (
				...
				gettext ( "Post deployment check" ) => array (
		...
		gettext ( "Infrastructure tests" ) => array (
				gettext ( "Test of infrastructure components with known vulnerabilities" ) => array (
						"risk" => "Das Betriebssystem oder seine Dienste enthalten bekannte Schwachstellen. Häufig laufen Docker-Container zu lange ohne System-Aktuallisierung zu erhalten.",
