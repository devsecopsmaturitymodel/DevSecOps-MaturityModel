<?php
$monitoring = array (
		gettext ( "Simple webapplication and system metrics" ) => array (
		...
		gettext ( "Screns with metric visualization" ) => array (
...
ksort ( $monitoring );
$logging = array (
		gettext ( "Centralized logging" ) => array (
		...
		gettext ( "Exception of applications are gathered" ) => array (
...
$dimensions [gettext ( "Information gathering" )] = array (
		gettext ( "Monitoring and Metric" ) => $monitoring,
